...
/* ------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
  const toggleImportanceOf = id => {
    ...
    .update(id, changedPerson).then(returnedPerson => {
      setPersons(persons.map(person => person.id !== id ? person : returnedPerson)) //* The callback function sets the component's persons state to a new array that contains all the items from the previous persons array, except for the old person which is replaced by the updated version of it returned by the server:
